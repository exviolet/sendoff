...
<img src="public/sendoff-demo.gif" alt="Многострочный промпт набирается в Sendoff — список продолжается сам — затем Ctrl+Enter доставляет его одним блоком в tmux-пейн с Claude Code, и агент начинает отвечать" width="900" />
...
> **Отправка работает только в [desktop-сборке](https://github.com/exviolet/sendoff).**
...
> копирование буфера в clipboard. Sendoff — **desktop-first**; браузерная сборка
...
> [**sendoff-desktop**](https://github.com/exviolet/sendoff) — обёртка на
